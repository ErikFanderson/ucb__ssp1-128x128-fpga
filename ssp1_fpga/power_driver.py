...
class SuperSwitchSupplyDriver:
    """
    Supply 0 (Agilent3631A)
    CHANNEL_P6V: VDD (1.8V supply)
    CHANNEL_P25V: VDDPST (1.8V <-> 5.0V supply)
    CHANNEL_N25V: VBB (0V <-> -20V supply)

    Supply 1 (Keithley2230)
    CHANNEL_1: HVDD (5.0V <-> 70V supply)
    CHANNEL_2: HVSS (1.8V <-> 5.0V supply)
    CHANNEL_3: VDDH (5.0V supply)

    Supply 2 (Keithley2400)
    CHANNEL 1: HVBOOST (0 - 200V)
    """
